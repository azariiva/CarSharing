...
class SetUtils {
    ...
    public static Set<String> symmetricDifference(Set<String> set1, Set<String> set2) {
        var setDifference = new HashSet<>(set1);
        setDifference.retainAll(set2);
        var setSymmetricDifference = new HashSet<>(set1);
        setSymmetricDifference.addAll(set2);
        setSymmetricDifference.removeAll(setDifference);
